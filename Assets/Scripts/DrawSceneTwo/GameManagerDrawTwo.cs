...
public class GameManagerDrawTwo : MonoBehaviour
{
    ...
    public TextMeshProUGUI StartTextTwo;
    public TextMeshProUGUI StartTextTwoGo;
    ...
    IEnumerator StartSet()
    {
        ...
        StartTextTwoGo.gameObject.SetActive(true);
        yield return new WaitForSeconds(1);
        ArrowPartOne.gameObject.SetActive(false);
        ArrowPartTwo.gameObject.SetActive(false);
        StartTextTwoGo.gameObject.SetActive(false);
    ...
    IEnumerator ShowResults()
    {
        ...
        GameObject.Find("DrawTwoScore").GetComponent<DrawTwoScore>().drawTwoScore = twoDec;
