...
public class GameManagerDrawFour : MonoBehaviour
{
    ...
    public TextMeshProUGUI StartTextFour;
    public TextMeshProUGUI StartTextFourGo;
    ...
    IEnumerator StartSet()
    {
        ...
        StartTextFour.gameObject.SetActive(false);

        Do = GameObject.Find("DrawFour");
    ...
    IEnumerator ShowResults()
    {
        ...
        GameObject.Find("DrawFourScore").GetComponent<DrawFourScore>().drawFourScore = twoDec;
