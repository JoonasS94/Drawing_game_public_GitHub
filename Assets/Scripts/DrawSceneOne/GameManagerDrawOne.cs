...
public class GameManagerDrawOne : MonoBehaviour
{
    ...
    public TextMeshProUGUI StartTextOne;
    public TextMeshProUGUI StartTextOneGo;
    ...
    IEnumerator StartSet()
    {
        ...
        StartTextOne.gameObject.SetActive(false);

        Do = GameObject.Find("DrawOne");
        ...
        StartTextOneGo.gameObject.SetActive(true);
        ...
        StartTextOneGo.gameObject.SetActive(false);
        yield return new WaitForSeconds(5);
    ...
    IEnumerator ShowResults()
    {
        ...
        GameObject.Find("DrawOneScore").GetComponent<DrawOneScore>().drawOneScore = twoDec;
